...
import { CreateConsueldo, UpdateConsueldo, Consueldo } from '../../../../domain/model/Consueldo';

interface ConsueldoFormProps {
  /** Si se pasa initialData, el formulario está en modo edición */
  initialData?: Consueldo;
  onSubmit: (data: CreateConsueldo | UpdateConsueldo) => void;
  onCancel?: () => void;
  loading?: boolean;
}

/**
 * Componente Formulario: conSueldo.zul
 ...
 */
export const ConsueldoForm: React.FC<ConsueldoFormProps> = ({
  initialData,
  onSubmit,
  onCancel,
  loading,
  ...
  return (
    <form
      ...
      data-testid="consueldo-form"
      style={{ display: 'flex', flexDirection: 'column', gap: '1rem', maxWidth: 600 }}
    >
      <h3>{isEditMode ? 'Editar' : 'Crear'} conSueldo.zul</h3>
