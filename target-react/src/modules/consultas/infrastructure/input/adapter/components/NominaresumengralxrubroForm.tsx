...
import { CreateNominaresumengralxrubro, UpdateNominaresumengralxrubro, Nominaresumengralxrubro } from '../../../../domain/model/Nominaresumengralxrubro';

interface NominaresumengralxrubroFormProps {
  /** Si se pasa initialData, el formulario está en modo edición */
  initialData?: Nominaresumengralxrubro;
  onSubmit: (data: CreateNominaresumengralxrubro | UpdateNominaresumengralxrubro) => void;
  onCancel?: () => void;
  loading?: boolean;
}

/**
 * Componente Formulario: nominaresumenGralxRubro.zul
 ...
 */
export const NominaresumengralxrubroForm: React.FC<NominaresumengralxrubroFormProps> = ({
  initialData,
  onSubmit,
  onCancel,
  loading,
  ...
  return (
    <form
      ...
      data-testid="nominaresumengralxrubro-form"
      style={{ display: 'flex', flexDirection: 'column', gap: '1rem', maxWidth: 600 }}
    >
      <h3>{isEditMode ? 'Editar' : 'Crear'} nominaresumenGralxRubro.zul</h3>
