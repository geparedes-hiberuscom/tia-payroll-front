...
import { CreateComparativonominas, UpdateComparativonominas, Comparativonominas } from '../../../../domain/model/Comparativonominas';

interface ComparativonominasFormProps {
  /** Si se pasa initialData, el formulario está en modo edición */
  initialData?: Comparativonominas;
  onSubmit: (data: CreateComparativonominas | UpdateComparativonominas) => void;
  onCancel?: () => void;
  loading?: boolean;
}

/**
 * Componente Formulario: comparativoNominas.zul
 ...
 */
export const ComparativonominasForm: React.FC<ComparativonominasFormProps> = ({
  initialData,
  onSubmit,
  onCancel,
  loading,
  ...
  return (
    <form
      ...
      data-testid="comparativonominas-form"
      style={{ display: 'flex', flexDirection: 'column', gap: '1rem', maxWidth: 600 }}
    >
      <h3>{isEditMode ? 'Editar' : 'Crear'} comparativoNominas.zul</h3>
