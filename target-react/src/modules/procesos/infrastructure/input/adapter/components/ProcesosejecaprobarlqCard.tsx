...
interface ProcesosejecaprobarlqCardProps {
...
export const ProcesosejecaprobarlqCard: React.FC<ProcesosejecaprobarlqCardProps> = ({ item, onSelect, onEdit, onDelete }) => {
  const fields = Object.entries(item).filter(([key]) => key !== 'id');

  return (
    <article className="card" data-testid="procesosejecaprobarlq-card">
      <h3 style={{ marginTop: 0 }}>Procesosejecaprobarlq</h3>
