...
interface ProcesosejecaprobarlqDetailProps {
  item: Procesosejecaprobarlq;
  onEdit?: (item: Procesosejecaprobarlq) => void;
  onDelete?: (id: string) => void;
  onBack?: () => void;
}

export const ProcesosejecaprobarlqDetail: React.FC<ProcesosejecaprobarlqDetailProps> = ({ item, onEdit, onDelete, onBack }) => {
  return (
    <section className="card" data-testid="procesosejecaprobarlq-detail">
      <h2 style={{ marginTop: 0 }}>Detalle Procesosejecaprobarlq</h2>
      <dl>
