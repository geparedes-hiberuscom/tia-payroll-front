...
interface EjecucionbotCardProps {
  item: Ejecucionbot;
...
export const EjecucionbotCard: React.FC<EjecucionbotCardProps> = ({ item, onSelect, onEdit, onDelete }) => {
  const fields = Object.entries(item).filter(([key]) => key !== 'id');

  return (
    <article className="card" data-testid="ejecucionbot-card">
      <h3 style={{ marginTop: 0 }}>Ejecucionbot</h3>
