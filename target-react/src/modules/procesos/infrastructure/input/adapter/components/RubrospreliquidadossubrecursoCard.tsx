...
interface RubrospreliquidadossubrecursoCardProps {
...
export const RubrospreliquidadossubrecursoCard: React.FC<RubrospreliquidadossubrecursoCardProps> = ({ item, onSelect, onEdit, onDelete }) => {
  const fields = Object.entries(item).filter(([key]) => key !== 'id');

  return (
    <article className="card" data-testid="rubrospreliquidadossubrecurso-card">
      <h3 style={{ marginTop: 0 }}>Rubrospreliquidadossubrecurso</h3>
