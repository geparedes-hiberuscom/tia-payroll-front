...
interface InstanciasprocesosInstanciasprocesosdialogCardProps {
...
export const InstanciasprocesosInstanciasprocesosdialogCard: React.FC<InstanciasprocesosInstanciasprocesosdialogCardProps> = ({ item, onSelect, onEdit, onDelete }) => {
  const fields = Object.entries(item).filter(([key]) => key !== 'id');

  return (
    <article className="card" data-testid="instanciasprocesos-instanciasprocesosdialog-card">
      <h3 style={{ marginTop: 0 }}>InstanciasprocesosInstanciasprocesosdialog</h3>
