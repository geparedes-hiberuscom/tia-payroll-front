...
interface EjecucionproccierreDetailProps {
...
export const EjecucionproccierreDetail: React.FC<EjecucionproccierreDetailProps> = ({ item, onEdit, onDelete, onBack }) => {
  return (
    <section className="card" data-testid="ejecucionproccierre-detail">
      <h2 style={{ marginTop: 0 }}>Detalle Ejecucionproccierre</h2>
      <dl>
