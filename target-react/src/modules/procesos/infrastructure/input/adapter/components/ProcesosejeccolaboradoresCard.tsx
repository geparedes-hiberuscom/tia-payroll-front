...
interface ProcesosejeccolaboradoresCardProps {
...
export const ProcesosejeccolaboradoresCard: React.FC<ProcesosejeccolaboradoresCardProps> = ({ item, onSelect, onEdit, onDelete }) => {
  const fields = Object.entries(item).filter(([key]) => key !== 'id');

  return (
    <article className="card" data-testid="procesosejeccolaboradores-card">
      <h3 style={{ marginTop: 0 }}>Procesosejeccolaboradores</h3>
