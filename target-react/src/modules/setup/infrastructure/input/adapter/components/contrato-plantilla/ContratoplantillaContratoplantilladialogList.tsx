...
interface ContratoplantillaContratoplantilladialogListProps {
  items: ContratoplantillaContratoplantilladialogResponse[];
  loading?: boolean;
  ...
  if (items.length === 0) {
    return (
      <div style={{ textAlign: 'center', padding: '2rem', color: '#666' }}>
        No se encontraron plantillas de contrato.
      </div>
    );
  }

  return (
    <div data-testid="contratoplantilla-contratoplantilladialog-list" style={{ overflowX: 'auto' }}>
      <table
        style={{
          width: '100%',
